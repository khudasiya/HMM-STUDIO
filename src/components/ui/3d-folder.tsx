    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle at 50% 70%, var(--accent, #a855f7) 0%, transparent 70%)",
        ...
        {/* Folder title */}
        <h3
          className="text-lg font-semibold text-foreground mt-4 transition-all duration-300 tracking-tight"
          style={{
        ...
        {/* Project count */}
        <p
          className="text-sm text-muted-foreground transition-all duration-300 font-mono text-xs"
          style={{
            opacity: isHovered ? 0.7 : 1,
          }}
        >
          {projects.length} showcase assets
        </p>

        {/* Hover hint */}
        <div
          className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-1.5 text-xs text-muted-foreground transition-all duration-300 font-mono"
          style={{
    ...
    >
      ...
      <button
        ...
        className={cn(
          ...
          "rounded-full bg-purple-950/60 backdrop-blur-md",
      ...
      >
        <div
          className={cn("relative overflow-hidden", "rounded-2xl", "bg-[#0f0a1c]", "ring-1 ring-purple-500/30", "shadow-2xl")}
          style={{
        ...
        >
          <div className="relative overflow-hidden">
            ...
            >
              {projects.map((project) => (
                <img
                  ...
                  alt={project.title}
                  className="w-full h-auto max-h-[70vh] object-contain bg-black/50 flex-shrink-0"
                  style={{ minWidth: "100%" }}
                />
              ))}
            </div>
            ...
            <div className="absolute inset-0 pointer-events-none bg-gradient-to-t from-[#0f0a1c]/70 via-transparent to-transparent" />
          </div>

          <div
            className={cn("px-6 py-5", "bg-[#120b24]", "border-t border-purple-900/40")}
            style={{
              opacity: animationPhase === "complete" && !isClosing ? 1 : 0,
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 min-w-0">
                <h3 className="text-lg font-bold text-white tracking-tight truncate h-7">
                  {currentProject?.title}
                </h3>
                <div className="flex items-center gap-3 mt-1">
                  <p className="text-xs text-purple-300/80 font-mono">
                    <kbd className="px-1.5 py-0.5 mx-0.5 text-[10px] font-mono bg-purple-950/80 text-purple-300 rounded border border-purple-800/40">
                      ←
                    </kbd>
                    <kbd className="px-1.5 py-0.5 mx-0.5 text-[10px] font-mono bg-purple-950/80 text-purple-300 rounded border border-purple-800/40">
                      →
              ...
              <div className="flex items-center gap-2">
                <span className="text-[11px] font-mono text-purple-300/60">
                  {internalIndex + 1} / {projects.length}
                </span>
              </div>
            </div>
          </div>
