...
export const CardWalletShowcase: React.FC<CardWalletShowcaseProps> = ({
  ...
  subtitle = "Hover over the folder to explore our 6 audio production disciplines.",
}) => {
  return (
    <section className="py-20 px-4 max-w-7xl mx-auto relative z-20 overflow-hidden">
      ...
      <div className="text-center max-w-2xl mx-auto mb-14 relative z-10">
        <div className="authkit-badge mb-3 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-950/60 border border-purple-500/30 text-purple-300 text-xs font-mono">
      ...
      {/* ── THE ONLY ONE 3D FOLDER (CENTERPIECE) ── */}
